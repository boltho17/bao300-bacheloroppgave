            ...
            <form className="mt-3">
                <div>
                    <Col sm={6}>
                        ...
                        <TextAreaInput label={'Kort beskrivelse/Salgstekst*'} handleChange={props.handleChange} product={props.product} value={props.product.descriptionShort} config={{name: 'descriptionShort', rows: '2', cols: '35', maxLength: '70', placeholder: 'Fantastisk kaffe med smak av himmel og et hint av grønne blader..'}}/>
                        <Row>
                            <Col sm={6}>
