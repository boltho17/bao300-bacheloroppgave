                ...
                <div className="conteiner containerProductTop">
                    <div className="row">
                        ...
                        <div className="col-sm vendor-detail-view-right-content">
                            ...
                            <h5 className="content-custom-spaceing">Kontaktinfo:</h5>
                            <p>(47+) 902 92 929</p>
                            <p>{vendor?.user.email}</p>

                            <h5 className="content-custom-spaceing">Beskrivelse av bedriften:</h5>
                            ...
                            <div className="cutsom-padding-on-picture-vendor">
                        ...
                        <div className="cutsom-padding-on-picture-vendor">
                            ...
                            <h3 className="content-custom-spaceing">Handle kaffe fra denne leverandøren ></h3>
                        </div>
                    </div>
                </div>
            </div>
